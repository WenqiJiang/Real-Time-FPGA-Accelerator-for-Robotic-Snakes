...
template <>
void gate_template(FDATA_T* kernel_last_state, FDATA_T* kernel_input_state,
                   FDATA_T* bias, FDATA_T* lstm_last_state,
                   FDATA_T* lstm_input_state, FDATA_T* result) {
...
template <>
void forget_gate(FDATA_T* forget_gate_kernel_last_state,
                 FDATA_T* forget_gate_kernel_input_state,
                 FDATA_T* forget_gate_bias, FDATA_T* lstm_last_state,
                 FDATA_T* lstm_input_state, FDATA_T* forget_gate_result) {
  // input:
  ...
  sigmoid<FDATA_T>(forget_gate_result, forget_gate_result);
}

template <>
void input_gate(FDATA_T* input_gate_kernel_last_state,
                FDATA_T* input_gate_kernel_input_state,
                FDATA_T* input_gate_bias, FDATA_T* lstm_last_state,
                FDATA_T* lstm_input_state, FDATA_T* input_gate_result) {
  // input:
  ...
  sigmoid<FDATA_T>(input_gate_result, input_gate_result);
}

template <>
void tanh_gate(FDATA_T* tanh_gate_kernel_last_state,
               FDATA_T* tanh_gate_kernel_input_state, FDATA_T* tanh_gate_bias,
               FDATA_T* lstm_last_state, FDATA_T* lstm_input_state, 
  ...
  tanh<FDATA_T>(tanh_gate_result, tanh_gate_result);
}

template <>
void output_gate(FDATA_T* output_gate_kernel_last_state,
                 FDATA_T* output_gate_kernel_input_state,
                 FDATA_T* output_gate_bias, FDATA_T* lstm_last_state,
                 FDATA_T* lstm_input_state, FDATA_T* output_gate_result) {
  // input:
  ...
  sigmoid<FDATA_T>(output_gate_result, output_gate_result);
}

template <>
void elementwise_mul(FDATA_T* input_vector1, FDATA_T* input_vector2,
...
template <> 
void lstm(FDATA_T* forget_gate_kernel_last_state,
          FDATA_T* forget_gate_kernel_input_state, FDATA_T* forget_gate_bias,
          FDATA_T* input_gate_kernel_last_state,
          FDATA_T* input_gate_kernel_input_state, FDATA_T* input_gate_bias,
          FDATA_T* tanh_gate_kernel_last_state, 
          FDATA_T* tanh_gate_kernel_input_state, FDATA_T* tanh_gate_bias,
          FDATA_T* output_gate_kernel_last_state,
          FDATA_T* output_gate_kernel_input_state, FDATA_T* output_gate_bias,
          FDATA_T* lstm_last_state, FDATA_T* lstm_input_state,
          FDATA_T* last_candidate, FDATA_T* forget_gate_result,
  ...
  // tanh new candidate
  tanh<FDATA_T>(new_candidate, tanh_new_candidate_cache);
